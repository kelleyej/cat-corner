<script>
    ...
    function goToNextPage() {
        let nextPage = Number($page.params.id) + 1;
        goto(`/${nextPage}`);
    ...
    function goToPreviousPage() {
        let previousPage = Number($page.params.id) - 1;
        goto(`/${previousPage}`);
...
{#if error}
    <FetchError />
{:else if activePage >= 9 || !pages.includes(activePage)}
    <Error />
{:else}
    <Header />
    ...
    <div class="text-center flex justify-center mt-5 text-xxs md:text-base">
        ...
        <div>
            <input
                class="mr-1 sm:mr-2 accent-pink-200 cursor-pointer"
                type="checkbox"
                id="affection"
            ...
            {#each !breedName.length ? catBreeds : allCats as cat (cat.id)}
                ...
                >
                    <div class="flex mb-3 justify-between">
                        <div class="w-3/5">
                            <h2 class="font-bold ml-2 text-2xl">
                                {cat.name} 🐾
                            </h2>
                            <h3 class="italic mb-2 ml-2">
                                {cat.temperament}
                            </h3>
                        </div>
                        ...
                        <div class="flex items-center mb-1 mr-7">
                            ...
                            <div class="bg-slate-200 w-72 h-5">
                                <div
                                    ...
                                    style="width: {(cat.intelligence / 5) *
                                        100}%"
                                ></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mb-1 mr-7">
                            ...
                            <div class="bg-slate-200 w-72 h-5">
                                <div
                                    ...
                                    style="width: {(cat.dog_friendly / 5) *
                                        100}%"
                                ></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mb-1 mr-7">
                            ...
                            <div class="bg-slate-200 w-72 h-5">
                                <div
                                    ...
                                    style="width: {(cat.energy_level / 5) *
                                        100}%"
                                ></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mb-1 mr-7">
                            ...
                            <div class="bg-slate-200 w-72 h-5">
                                <div
                                    ...
                                    style="width: {(cat.adaptability / 5) *
                                        100}%"
                                ></div>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center mb-1 mr-7">
                            ...
                            <div class="bg-slate-200 w-72 h-5">
                                <div
                                    ...
                                    style="width: {(cat.child_friendly / 5) *
                                        100}%"
                                ></div>
                            </div>
                        </div>
